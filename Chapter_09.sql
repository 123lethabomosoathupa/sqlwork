...
COPY meat_poultry_egg_inspect FROM 'C:\Users\letha\Desktop\practical-sql-master\practical-sql-master\Chapter_09\MPI_Directory_by_Establishment_Name.csv' WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
-- Listing 9-26: Swapping table names using ALTER T
...
WHERE activities ilike '%meat process%';

UPDATE meat_poultry_egg_inspect
SET poultry_processing = true
WHERE activities ilike '%Poultry Process%';
